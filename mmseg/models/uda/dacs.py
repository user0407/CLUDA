...
class DACS(UDADecorator):
    ...
    def forward_train_final(self,
        ...
        # if self.file == img_metas[0]['ori_filename']:
        #     att = src_att.detach().cpu().numpy()
        #     np.save('/pfs/rdi/cei/algo_train/mvayyat/hrda_nb/ld_wt/iter' + str(self.local_iter), att)
